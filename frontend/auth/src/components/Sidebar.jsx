...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {icon: <IoIosAddCircle className="text-xl "/>,text:'Add Employee', to: "/create"},
    { icon: <CiLogout className="text-xl " onClick={handleLogout}/>, text: "Logout",to:'/' },
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`bg-white h-full min-h-full w-64 shadow-xl py-10 px-4 flex flex-col fixed top-0 left-0 z-40 transform transition-transform duration-300 ease-in-out 
